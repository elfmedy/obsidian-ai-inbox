...
import { ReceiptSchema, type SaveReceipt, Digest, parseSaveRequest, stableJson, type SaveRequestData, type SnapshotData } from './schema';
...
export type { SaveReceipt } from './schema';
