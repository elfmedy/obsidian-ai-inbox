// MIT Pionxzh; adapted from d0f44aae9d5650852b2979bbf830590b41f7b804.
// Changes: preserve source punctuation/whitespace and unresolved markers.
// See THIRD_PARTY_NOTICES.md.
import type { ContentReference, ContentReferenceSource } from './citations'
...
export function transformContentReferences(
    input: string,
    metadata: { content_references?: ContentReference[] },
    ...
    for (const ref of sortedRefs) {
        ...
        if (replacement) output = output.replaceAll(matchedText, replacement)
    }
